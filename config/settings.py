...
ASTERISK_URL = os.environ.get('ASTERISK_URL', 'http://192.168.1.1:8088')
ASTERISK_USERNAME = os.environ.get('ASTERISK_USERNAME', 'paleo')
ASTERISK_PASSWORD = os.environ.get('ASTERISK_PASSWORD', 'paleo7top')
